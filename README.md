...
| argo-cd |  | 10.3.2 | 10.9.1 (v3.5.3) |
| argo-rollouts |  | 2.41.1 | 2.43.1 (v1.10.0) |
| argo-workflows |  | 1.0.24 | 2.0.6 (v4.1.3) |
| atlantis |  | 6.11.0 | 6.15.1 (v0.47.1) |
| external-dns |  | 1.21.1 | 1.22.0 (0.22.0) |
...
| prometheus-stack |  | 88.2.0 | 91.4.0 (v0.94.0) |
| vllm-stack |  |  | 0.1.12 |
<!--- END_VERSION --->
